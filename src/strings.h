...
static const wchar_t* const kStrings_enUS[STR_COUNT] = {
    ...
    /* STR_UI_BTN_UNINSTALL    */ L"Uninstall",
    ...
    /* STR_USAGE               */ L"Usage:\n"
        ...
        L"Run without arguments for the graphical install/upgrade/uninstall wizard.",
};
